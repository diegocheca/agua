$(document).ready(function () {
    ...
    */
    ...
    /* Secundario Pie Chart */
    if ($('.sec-pie-1')[0]) {
        easyPieChart('sec-pie-1', '#ddd', '#aaa', '#00BCD4', 7, 'butt', 148);
    }
    if ($('.sec-pie-2')[0]) {
        easyPieChart('sec-pie-2', '#ddd', '#aaa', '#8BC34A', 7, 'butt', 148);
    }
    if ($('.sec-pie-3')[0]) {
        easyPieChart('sec-pie-3', '#ddd', '#aaa', '#E91E63', 7, 'butt', 148);
    }
    
    /* Others */
    if ($('.sub-pie-1')[0]) {
        easyPieChart('sub-pie-1', '#eee', '#ccc', '#00bcd4', 7, 'butt', 148);
    }
