...
<div class="row" ng-app="formApp"  ng-controller="MainCtrl" >
	...
	if($factura[0]->Conexion_Latitud == "1" )
		$riego = floatval ($datos[17]->Configuracion_Valor);
	else  $riego  =  0;
	if($riego  == null)
		$riego  =0;
	...
	if ((intval(date("d"))>=14) && (intval(date("d"))<=30) )
	{
		...
		$monto_total  = arreglar_numero(floatval($monto_total ) + floatval($monto_total )  * floatval(0.015) );
					...
					<div class="row">
						...
						<tbody>
							<tr>
								...
								<td>
									<div class="fg-line">
										<input id="inputDeudaAnterior_tabla" type="text" name="deudaTotal" ng-model="deuda_anterior_a" ng-change="calcular_montos()" 
										<?php 
										if( isset($factura))
										{
							...
							<tr>
								...
								<td>Tarifa Basica</td>
								<td></td>
								<td><input type="text" name="deudaTarifa" id="inputTarifaSocial"  ng-model="tarifa_social_a" ng-change="calcular_montos()"   
								<?php 
							...
							<tr>
								...
								<td> Excedente</td>
								<td></td>
								<td><input type="text" name="deudaExcente" id="inputdeudaExcente" ng-model="exdenete_a"  ng-change="calcular_montos()"
								<?php 
									if( isset($factura))
									{
							...
							<tr>
								...
								<td> Couta Social</td>
								<td></td>
								<td><input type="text" name="cuotaSocial" id="inputdeudaCuotaSocial" ng-model="cuota_social_a" ng-change="calcular_montos()"
								<?php 
									if( isset($factura)  )
									{
							...
							<tr  class="table-warning">
								...
								<td>
									<input type="text" name="planmedidor" id="inputplanmedidor"  ng-model="monto_cuota_medidor_a" ng-change="calcular_montos()"
									<?php 
							...
							<tr>
								...
								<td>
								<input type="text" name="planpago" id="inputplanpago" ng-model="monto_cuota_plan_a" ng-change="calcular_montos()"
									<?php 
									if( isset($factura) &&  (is_numeric( $factura[0]->PlanPago_Id) ) )
									{
							...
							<tr class="table-info">
								...
								<td> RIego </td>
								<td></td>
								<td><input type="text" name="riego" id="riego" ng-model="riego_a" ng-change="calcular_montos()"
								<?php 
									if( isset($factura) )
									{
										echo 'value="'.$riego.'" ';
							...
							<tr class="table-info">
								...
								<td> SubTotal </td>
								<td></td>
								<td><input type="text" name="subtotal" id="inputsubtotal" ng-model="subtotal_a" ng-change="calcular_montos()"
								<?php 
									if( isset($factura) )
									{
										echo 'value="'.$subtotal.'" ';
							...
							<tr class="table-info">
								...
								<td></td>
								<td><input type="text" name="pagosacuenta" id="inputpagosacuenta" ng-model="pago_a_cuenta_a" ng-change="calcular_montos()"
								<?php 
							...
							<tr class="table-info">
							  ...
							  <td><input type="text" name="endeuda" id="inputendeuda" ng-model="endeuda_a" ng-change="calcular_montos()"></td>
							</tr>
							<tr>
								<td></td>
								<td></td>
							...
							<tr class="table-success">
								...
								<td> Total </td>
								<td></td>
								<td><input type="text" name="total" id="inputtotal" ng-model="monto_total_a" ng-change="calcular_montos()"
								<?php 
								if(isset($factura))
						...
						<tr class="table-success">
							  ...
							  <td></td>
							  <td><input type="text" name="descuento_a_aplicar" id="descuento_a_aplicar" ng-model="descuento_a_aplicar_a" ng-change="calcular_montos()"></td>
							</tr>
