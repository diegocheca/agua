					...
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<div class="modal-body">
								<form id="formulario_filtro_sector" method="POST" action="<?php echo base_url('nuevo/mostar_descuentos'); ?>">
									<div class="card-body card-padding text-center">
										...
										<div class="row">
											...
											<select name="anio_select_descuentos"  id="anio_select_mediciones_raras" class="chosen" data-placeholder="Elige el año" >
											<option value="-1" selected disabled >Sin Filtro</option>
							...
							<div class="modal-body">
								<form id="formulario_aprobando_medicion" method="POST" action="<?php echo base_url('nuevo/aprobar_descuento'); ?>">
									<div class="card-body card-padding text-center">
										...
										<input id="conexion_id_input" type="hidden" name="conexion_id_input" class="form-control input-sm" >
										...
										<div class="input-group form-group">
											<span class="input-group-addon"><i style="color:green" class="zmdi zmdi-assignment"></i> Decision</span>
				...
				<table id="data-table-autoriazar-bonificacion" class="table table-striped table-vmiddle">
					<thead>
						<tr>
							...
							<th data-column-id="descision" >Dec </th>
							<th data-column-id="conexion_id" >Con Id</th>
							<th data-column-id="Tarifa_social" data-visible="false">Tarifa social</th>
							<th data-column-id="cuota_social">Excedente</th>
							<th data-column-id="Excedente_precio">Cuota Social</th>
					...
					<tbody>
					<?php foreach ($facturas as $columna):?>
						<tr>
							<td><?php echo $columna->Factura_Id; ?></td>
							<td><?php
							if($columna->Factura_DescuentoRevisado == 0)
								echo "Sin Ver"; 
							elseif($columna->Factura_DescuentoRevisado == 1)
								echo "Aprobado"; 
							else echo "Reprobado"; ?></td>
							<td><?php echo $columna->Factura_Conexion_Id; ?> </td>
							<td><?php echo $columna->Factura_TarifaSocial; ?> </td>
							<td><?php echo $columna->Factura_ExcedentePrecio; ?> </td>
							<td><?php echo $columna->Factura_CuotaSocial; ?> </td>
							<td><?php echo $columna->Factura_PM_Cant_Cuotas; ?> </td>
							<td><?php echo $columna->Factura_PM_Cuota_Actual; ?> </td>
							<td><?php echo $columna->Factura_PM_Cuota_Precio; ?> </td>
							<td><?php echo $columna->Factura_PP_Cant_Cuotas; ?> </td>
							<td><?php echo $columna->Factura_PP_Cuota_Actual; ?> </td>
							<td><?php echo $columna->Factura_PPC_Precio; ?> </td>
							<td><?php echo $columna->Factura_Riego; ?> </td>
							<td><?php echo $columna->Factura_SubTotal; ?> </td>
							<td><?php echo $columna->Factura_Acuenta; ?> </td>
							<td><?php echo $columna->Factura_Bonificacion; ?> </td>
							<td><?php echo $columna->Factura_Total; ?> </td>
							<td><?php echo $columna->Factura_Descuento; ?> </td>
							<td><?php echo $columna->Factura_Vencimiento1_Precio; ?> </td>
							<td><?php echo $columna->Factura_Vencimiento2_Precio; ?> </td>
							...
							<td><?php echo $columna->Factura_PagoAtrasado; ?> </td>
							<td><?php echo $columna->Factura_PagoMonto; ?> </td>
							<td><?php echo $columna->Factura_PagoContado; ?> </td>
							<td><?php echo $columna->Factura_PagoCheque; ?> </td>
							<td><?php echo $columna->Factura_PagoTimestamp; ?> </td>
							<td><?php echo $columna->Factura_Mes; ?> </td>
							<td><?php echo $columna->Factura_Año; ?> </td>
							<td><?php echo $columna->Factura_Timestamp; ?> </td>
							<td></td>
						</tr>
					<?php endforeach; ?>
					</tbody>
