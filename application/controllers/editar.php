...
$this->load->view('templates/footer_fin');
	...
	public function cliente($id_cliente){
		...
		if (!$this->session->userdata('login') || $this->uri->segment(3) == FALSE):
			...
			$datos['info'] 		=	$this->Crud_model->get_data_join_sin_borrados_clientes("clientes", "conexion", "Cli_Borrado", "Cli_Id", "Conexion_Cliente_Id",$id_cliente);
		//var_dump($datos['info']);die();
